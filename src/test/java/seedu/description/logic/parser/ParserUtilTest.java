...
import static seedu.description.logic.parser.ParserUtil.MESSAGE_INVALID_INDEX;
...
public class ParserUtilTest {
    ...
    public void parsePhone_validValueWithoutWhitespace_returnsPhone() throws Exception {
        Location expectedLocation = new Location(VALID_PHONE);
        assertEquals(expectedLocation, ParserUtil.parsePhone(VALID_PHONE));
    }
    ...
    public void parsePhone_validValueWithWhitespace_returnsTrimmedPhone() throws Exception {
        ...
        Location expectedLocation = new Location(VALID_PHONE);
        assertEquals(expectedLocation, ParserUtil.parsePhone(phoneWithWhitespace));
    }
