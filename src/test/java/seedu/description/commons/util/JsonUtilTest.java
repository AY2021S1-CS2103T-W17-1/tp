...
import seedu.description.testutil.SerializableTestClass;
import seedu.description.testutil.TestUtil;
...
public class JsonUtilTest {
    ...
    public void serializeObjectToJsonFile_noExceptionThrown() throws IOException {
        ...
        Assertions.assertEquals(FileUtil.readFromFile(SERIALIZATION_FILE),
