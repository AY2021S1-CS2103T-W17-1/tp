...
import static seedu.description.storage.JsonAdaptedPerson.MISSING_FIELD_MESSAGE_FORMAT;
...
public class JsonAdaptedBugTest {
    ...
    private static final String VALID_PHONE = TypicalPersons.BENSON.getLocation().toString();
    private static final String VALID_ADDRESS = TypicalPersons.BENSON.getDescription().toString();
