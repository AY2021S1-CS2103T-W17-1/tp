...
import seedu.description.commons.util.CollectionUtil;
...
public class EditCommand extends Command {
    ...
    private static Bug createEditedPerson(Bug bugToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        Location updatedLocation = editPersonDescriptor.getPhone().orElse(bugToEdit.getLocation());
        Description updatedDescription = editPersonDescriptor.getAddress().orElse(bugToEdit.getDescription());
        Set<Tag> updatedTags = editPersonDescriptor.getTags().orElse(bugToEdit.getTags());

        return new Bug(updatedName, updatedLocation, updatedDescription, updatedTags);
    }
    ...
    public static class EditPersonDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(name, location, description, tags);
        }
        ...
        public void setPhone(Location location) {
            this.location = location;
        }

        public Optional<Location> getPhone() {
